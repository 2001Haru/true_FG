...
parser.add_argument('--dataset_dir', nargs='+', default=["/root/autodl-tmp/datasets/ImageNet"])
...
parser.add_argument("--accumulation_steps", type=int, default=1, help="n_neighbors for the umap before hdbscan")
parser.add_argument("--n_neighbors", type=int, default=15, help="n_neighbors for the umap before hdbscan")
parser.add_argument("--min_cluster_size", type=int, default=5, help="hdbscan Size Min")
...
parser.add_argument('--save_dir_plot', type=str, default=".")
parser.add_argument('--use_vae', action="store_true", default=False, help="use vae for plots")
parser.add_argument('--epoch_print_freq', type=int, default=None, help='print frequency for each epoch')
...
if args.ipc > 0 and args.epochs is None:
    if args.dataset == 'imagenet':
        ...
        epoch_print_freq = args.epochs // 100
    else:
        args.epochs = 1000
        epoch_print_freq = args.epochs
else:
    epoch_print_freq = 1

if args.epoch_print_freq is None:
    args.epoch_print_freq = epoch_print_freq
